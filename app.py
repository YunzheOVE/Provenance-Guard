...
def generate_label(confidence: float) -> str:
    ...
    if confidence >= 0.65:
        return (
            ...
            f"Our automated analysis found patterns associated with AI-generated writing "
            f"(AI signal strength: {pct}%). This label is generated by an automated system "
            f"and may be incorrect.\n\n"
        ...
        return (
            ...
            f"Our automated analysis found patterns consistent with human-written content "
            f"(AI signal strength: {pct}%). This assessment is automated and may not be "
            f"accurate in all cases."
        )
    else:
        return (
            "[ Attribution Uncertain ]\n\n"
            f"Our system could not confidently determine whether this content was written "
            f"by a human or produced by an AI tool (AI signal strength: {pct}%). "
            f"Both human and AI-generated text can produce results in this range.\n\n"
...
def appeal():
    ...
    # Find the original submission entry
    submission = next(
        (e for e in entries if e.get("content_id") == content_id and e.get("entry_type") == "submission"),
        None,
    )
    ...
    # Update submission status in-place
    ...
    return jsonify({
        "status": "received",
        "content_id": content_id,
        "message": "Your appeal has been logged and will be reviewed by a human.",
    })
